...
#SBATCH --output=/home/<YOUR NAME>/wandb_tutorial/slurm/%j.out       
#SBATCH --mem=64000MB
...
python_output=$(python /home/<YOUR NAME>/wandb_tutorial/wandb_tutorial.py --resume --lr=${lr} --batch_size=${batch_size} --run_id="$1")
